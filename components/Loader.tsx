...
export const Loader: React.FC<LoaderProps> = ({ message }) => {
  return (
    <div className="flex flex-col items-center justify-center h-96 text-slate-600">
      ...
      <p className="mt-4 text-lg font-semibold animate-pulse-fast">{message || 'Processing...'}</p>
      <p className="mt-2 text-sm text-slate-500">This may take a moment, especially for complex images.</p>
    </div>
  );
};